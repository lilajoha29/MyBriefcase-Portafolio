        ...
        <div className=" flex flex-col justify-around items-center lg:flex-row ">
            <div className=" flex flex-col rounded-lg w-60 h-44 p-auto my-4 sm:w-96 sm:h-52">
                ...
                <div className="rounded-lg bg-negro flex justify-around mt-1 ">
                    <a href="https://github.com/lilajoha29/calculadora" ><img src="./img/github.svg" className="w-6 h-6 sm:h-8"></img></a>
            ...
            <div className=" flex flex-col rounded-lg w-60 h-44 p-auto m-10 sm:w-96 sm:h-52 ">
                <img src="./img/juego.png" className="w-60 h-44 rounded-lg sm:w-96 sm:h-52"></img>
                <div className="rounded-lg bg-negro flex justify-around mt-1">
                    <a href="https://github.com/H4r0l/Wheel-of-DOM"><img src="./img/github.svg" className="w-6 h-6 sm:h-8"></img></a>
            ...
            <div className=" flex flex-col rounded-lg w-60 h-44 p-auto my-4 sm:w-96 sm:h-52">
                <img src="./img/tetris.png" className="w-60 h-44 rounded-lg sm:w-96 sm:h-52"></img>
                <div className="rounded-lg bg-negro flex justify-around mt-1">
                    <a href="https://github.com/JeffersonPulido/TetrisGame"><img src="./img/github.svg" className="w-6 h-6 sm:h-8"></img></a>
