...
export const Header = () => {
  ...
  return (
    <div id="header" className="flex flex-row text-center ">
      <button id="burger" onClick={()=> setIsOpen(!isOpen)} className="font-DynaPuff text-blanco px-5 hover:text-rosado"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-16 h-16">
