...
const Inicio = () => {
  return (
    <div id="inicio" class="relative flex flex-col items-center">
      ...
      <div class="pl-32 pb-52">
        {/* <link to="/hv"> */}
          <button id="boton" class="font-DynaPuff bg-rosado text-blanco rounded-lg flex flex-row pr-3 pl-3 hover:text-rosado hover:bg-blanco">from my
            <span class="flex items-center space-x-5">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
              class="w-6 h-6 text-blanco hover:text-rosado">
